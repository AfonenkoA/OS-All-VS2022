...
int main()
{
    ...
    if (!GetMailslotInfo(
        ...
        nullptr,       // максимальный размер сообщения не нужен
        &dwNextMessageSize,  // размер следующего сообщения
        &dwMessageCount,     // количество сообщений
    nullptr))       // интервал ожидания не нужен
    {
    ...
    while (dwMessageCount != 0)
    {
        ...
        char* pchMessage = new char[dwNextMessageSize];
        ...
        if (!ReadFile(
            ...
            nullptr            // передача данных синхронная
        ))
        {
